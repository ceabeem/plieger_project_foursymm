            ...
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-black sbold uppercase">File Send For Data Circle Review</span>
                    </div>
                    <div class="col-md-3 pull-right">
                ...
                <div class="portlet-body">
                        ...
                        <div id="user_data1" >
                            @include('Admin.GIS.PliegerReview.pending_page2')
                        </div> 
                        </div>
                </div>
            </div>
        ...
        <div class="col-md-11">
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-settings font-black"></i>
                        <span class="caption-subject font-black sbold uppercase">Feedback From Data Circle</span>
                    </div>
                    <div class="col-md-3 pull-right">
                ...
                <div class="portlet-body">
                        <div class="table-scrollable">
                        <div id="user_data" >
                            @include('Admin.GIS.PliegerReview.pending_page')
                        </div>
...
function appendCommunityServices(pendings) {
        ...
        function getMorePendings1(page)
        {
            ...
            ({
                type : 'GET',
                url : "{{ route('gsi.reviewpending.getMorePliegerReview1')}}"+"?page="+page,
                data : {
                    'search_query' : search
                },
        ...
        function getMorePendings(page)
        {
            ...
            ({
                type : 'GET',
                url : "{{ route('gsi.reviewpending.getMorePliegerReview2')}}"+"?page="+page,
                data : {
                    'search_query' : search
                },
                success:function(data){
