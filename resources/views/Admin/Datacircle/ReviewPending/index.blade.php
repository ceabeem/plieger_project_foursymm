        ...
        <div class="col-md-11">
            <div class="portlet light portlet-fit bordered">
                ...
                <div class="portlet-body">
                        ...
                        <div id="user_data" >
                            @include('Admin.Datacircle.ReviewPending.pending_page')
                        </div>
...
function appendCommunityServices(pendings) {
        ...
        $(document).on('click', '.pliegerreview', function(event) {
            ...
            dialog.init(function(){
                setTimeout(function(){
                  ...
                  var html = '<form action="" id="queries" class="horizontal-form" data-rowIndex="'+rowIndex+'">'+
                    '{{ csrf_field() }}'+
        ...
        $(document).on('submit', '#queries', function(event) {
        event.preventDefault();
        var form = $(this);
        var formData = form.serialize();

        $.ajax({
            url: "pending/pliegerreview",
            type: 'POST',
            data: formData,
            success: function(res) {
                if (res.status === 1) {
        ...
        //     bootbox.confirm({
        //         message: "Do you want to send for Plieger Review",
        //         buttons: {
        //             confirm: {
        //                 label: 'Yes',
        //                 className: 'btn green'
        ...
        //         callback: function (result) {
        //             if (result) {
        //                 var url = 'pending/pliegerreview/'+ pendingID;
