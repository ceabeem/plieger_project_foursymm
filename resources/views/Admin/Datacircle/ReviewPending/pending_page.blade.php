                    ...
                    @if(isset($pendings) && !empty($pendings))
                                  @foreach($pendings as $pending)
                                    <tr data-pendingID="<?php echo $pending['id'];?>">
                                        ...
                                        <a href="javascript:;" class="btn btn-outline btn-circle dark btn-sm green pliegerreview" style="margin: 1%"> <i class="fa fa-repeat"></i>Send for Data Circle Review </a> 
