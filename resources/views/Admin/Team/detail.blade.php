                                ...
                                <thead>
                                    <tr><th>S.no</th>
                                        <th>
                                            ...
                                            <th>
                                            <i class="fa fa-user"></i> Reviewed By Team Leader </th>
                                            <th>
                                            <i class="fa fa-user"></i> Reviewed By Supervisor </th>
                                ...
                                <tbody>
                                    ...
                                    @foreach($members as $member)
                                        <tr data-memberID="<?php echo $member['id'];?>">
                                            ...
                                            <td>{{$member['team_leader_reviewed']}}</td>
                                            <td>{{$member['team_supervisor_reviewed']}}</td>
