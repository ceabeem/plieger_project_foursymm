        ...
        <div class="col-md-11">
            <div class="portlet light portlet-fit bordered">
                ...
                <div class="portlet-body">
                        ...
                        <div id="user_data" >
                                @include('TeamLeader.Datacircle.Task.assigntask_page')
                            </div>
...
function appendCommunityServices(tasks) {
        ...
        function getallmembers()
        {
            var member_names = [];
            $.ajax({
                url: "{{route('datacircle.assigntask.getallmembers')}}",
                type: 'GET',
                dataType: 'json',
                async:false,
                success: function(res) {
        ...
        $(document).on('click', '.editBtn', function(event) {
            ...
            dialog.init(function(){
                setTimeout(function(){
                    ...
                    var url = 'assigntask/' + taskID + '/edit';
        ...
        function getMoreTasks(page)
        {
            ...
            ({
                type : 'GET',
                url : "{{ route('datacircle.assigntask.getMoreTasks')}}"+"?page="+page,
                data : {
                    'search_query' : search
                },
