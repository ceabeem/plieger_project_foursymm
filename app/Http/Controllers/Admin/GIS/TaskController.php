...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        $flag = 0;
        $members =Member::where('role_id','!=',1)->where('role_id','!=',3)->where('role_id','!=',6)->where(function($query) use ($flag){
        ...
        return view('Admin.GIS.Task.index',compact('tasks','members','user'))->with('no',1);
    }
    ...
    public function getallmembers()
    {
        $status = 0 ;
        $flag = 0;
        $member_names = Member::where('role_id','!=',1)->where('role_id','!=',3)->where('role_id','!=',6)->where(function($query) use ($flag){
            $query->where('flag',$flag);
        })->get();
        $status = 1;
        return response([
