...
class AssignTaskController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('TeamLeader.Datacircle.Task.assigntask',compact('tasks','members','user'))->with('no',1);
    }
    ...
    public function search(Request $request)
    {
            ...
            $data = Task::$tasks = Task::where('project_id',1)->where(function($query) use ($search){
