...
class ReviewController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('TeamLeader.Datacircle.Review.index',compact('reviews','user'))->with('no',1);
    }
    ...
    public function getMoreReviews(Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            $no = 1;
            return view('TeamLeader.Datacircle.Review.review_page',compact('reviews','user','no','search'))->render();
        }
