...
class ReviewPendingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('TeamLeader.GIS.ReviewPending.index',compact('pendings','user'))->with('no',1);        
    }
    ...
    public function view($id)
    {
        ...
        return view('TeamLeader.GIS.Review.detail',compact('taskview','user'))->with('no',1);
    }
    ...
    public function getMorePendings(Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            $no = 1;
            return view('TeamLeader.GIS.ReviewPending.pending_page',compact('pendings','user','no','search'))->render();
        }
