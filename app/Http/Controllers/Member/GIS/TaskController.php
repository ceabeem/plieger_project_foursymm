...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Member.GIS.Task.index',compact('tasks','user'))->with('no',1);
    }
    ...
    public function review()
    {
        ...
        return view('Member.GIS.Task.review',compact('reviews','user'))->with('no',1);
    }
    ...
    public function search(Request $request)
    {
            ...
            $data = Task::where('project_id',2)->where(function($query) use ($status){
                $query->where('status',$status);
        ...
        public function getMoreTasks(Request $request)
        {
            ...
            if($request->ajax())
            {
                ...
                $no = 1;
                return view('Member.GIS.Task.task_page',compact('tasks','user','no','search'))->render();
            }
        ...
        public function getMoreReviews(Request $request)
        {
            ...
            if($request->ajax())
            {
                ...
                $no = 1;
                return view('Member.GIS.Task.review_page',compact('reviews','user','no','search'))->render();
            }
